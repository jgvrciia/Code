...
if name.capitalize() == "Diego" or name.capitalize() == "Eddie":
    evil = input("Are you evil? (yes/no)\n> ")
    if evil == "Yes".casefold():
        print("GET OUT EVIL " + name + "!! YOU'RE BANNED FROM THIS COFFEE SHOP!!")
        exit()
    else:
        print("Sorry for the confusion we have an evil Diego roaming around")
